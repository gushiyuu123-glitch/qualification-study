...
export const q09 = {
  ...
  "items": [
    ...
    {
      "part": "C",
      "prompt": "コンピュータ環境における色空間の色選択について、正しい説明はどれか。",
      "choices": [
        "CMYKでは16進数を使い、黒を#000000、白を#FFFFFFと表す",
        "RGBでは色料の三原色を各256段階で組み合わせる",
        "HSBでは色相を角度、彩度と明度を0〜100%の範囲で設定する",
        "Webセーフカラーでは色の三属性をそれぞれ0〜100%で指定する"
      ],
      "correctIndex": 2,
      "explanation": "HSBはHue（色相）を角度で、Saturation（彩度）とBrightness（明度）を百分率で設定する。RGBは光の三原色であり、16進数表記はRGB系の指定で使われる。"
    },
    {
      "part": "D",
